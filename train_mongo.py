...
with open("vocab_mongo.json", "w") as f:
...
# --- Final Model Save ---
torch.save(model.state_dict(), "llms/querycraft_mongo_llm.pt")
print("Final model saved successfully → llms/querycraft_mongo_llm.pt")
